...
$.get("/api/all", function(data) {
        ...
        for (var i = 0; i < data.length; i++) {
            ...
            $("#family-well-" + i).append("<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
            <input type="hidden" name="cmd" value="_s-xclick">
            <input type="hidden" name="hosted_button_id" value="7ZWTP7888FHQ8">
